...
[![Build Status](https://github.com/omegion1npm/qui-optio-sit/workflows/CI-CD/badge.svg?branch=master)](https://github.com/omegion1npm/qui-optio-sit/actions)
[![Coverage Status](https://coveralls.io/repos/github/omegion1npm/qui-optio-sit/badge.svg?branch=master)](https://coveralls.io/github/omegion1npm/qui-optio-sit)
[![Tested on APIs.guru](https://api.apis.guru/badges/tested_on.svg)](https://apis.guru/browse-apis/)

[![npm](https://img.shields.io/npm/v/@omegion1npm/qui-optio-sit.svg)](https://www.npmjs.com/package/@omegion1npm/qui-optio-sit)
[![Dependencies](https://david-dm.org/omegion1npm/qui-optio-sit.svg)](https://david-dm.org/omegion1npm/qui-optio-sit)
[![License](https://img.shields.io/npm/l/@omegion1npm/qui-optio-sit.svg)](LICENSE)
[![Buy us a tree](https://img.shields.io/badge/Treeware-%F0%9F%8C%B3-lightgreen)](https://plant.treeware.earth/omegion1npm/qui-optio-sit)

[![OS and Browser Compatibility](https://apitools.dev/img/badges/ci-badges-with-ie.svg)](https://github.com/omegion1npm/qui-optio-sit/actions)
...
- **[Tested](https://github.com/omegion1npm/qui-optio-sit/actions)** in Node.js and all modern web browsers on Mac, Windows, and Linux
...
```bash
npm install @omegion1npm/qui-optio-sit
```
...
```javascript
const SwaggerParser = require("@omegion1npm/qui-optio-sit");
```

When using a transpiler such as [Babel](https://babeljs.io/) or [TypeScript](https://www.typescriptlang.org/), or a bundler such as [Webpack](https://webpack.js.org/) or [Rollup](https://rollupjs.org/), you can use **ECMAScript modules** syntax instead:

```javascript
import * as SwaggerParser from '@omegion1npm/qui-optio-sit';
```
...
Contributing
--------------------------
I welcome any contributions, enhancements, and bug-fixes.  [Open an issue](https://github.com/omegion1npm/qui-optio-sit/issues) on GitHub and [submit a pull request](https://github.com/omegion1npm/qui-optio-sit/pulls).

#### Building/Testing
To build/test the project locally on your computer:

1. __Clone this repo__<br>
`git clone https://github.com/omegion1npm/qui-optio-sit.git`
...
This package is [Treeware](http://treeware.earth). If you use it in production, then we ask that you [**buy the world a tree**](https://plant.treeware.earth/omegion1npm/qui-optio-sit) to thank us for our work. By contributing to the Treeware forest you’ll be creating employment for local families and restoring wildlife habitats.
